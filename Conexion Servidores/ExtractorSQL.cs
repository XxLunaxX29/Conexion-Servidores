        ...
        public async Task<(bool Success, Dictionary<string, object> Stats, string Message)> ObtenerEstadisticasAsync()
        {
            ...
            try
            {
                ...
                if (await reader.ReadAsync())
                {
                    ...
                    stats["CategoríasUnicas"] = reader["CategoríasUnicas"];
                    stats["PrecioMínimo"] = Convert.ToDecimal(reader["PrecioMínimo"]);
                    stats["PrecioMáximo"] = Convert.ToDecimal(reader["PrecioMáximo"]);
